...
<h4>Progress Report</h4>: Final presentation of the game was demonstrated to the class on 19 January 2018. A video demonstrating the game play and quick walk-through was created alongside, and uploaded to YouTube. The game mechanics worked perfectly together with the sound, lighting, environment, and overall gameplay. The response was favourable given the severe limitations of the team's size and resources. The scoring system and additional features also worked, though there was insufficient time to demonstrate all of these. As Daniel Nicholson was unwell on the day, Arjun Khara presented the project and demonstrated the game alone. However, since both members have worked equally hard on this project, either was capable of presenting single-handedly given the intimate level of understanding both have of the game and its code base, programming structures, essence, and core gameplay features. The project, in its MVP stage, is now coming to a close and the team members, Arjun Khara and Daniel Nicholson, will gather for one more post-project meeting to analyse the benefits and challenges that came out of this project, and implement any learnings towards new projects that we will build and code this year (2018). This entry therefore marks the final progress report for this project: FireFighters (Haunted Hose), and sums up perhaps the most important lesson the team learned: no matter how difficult the going gets, no matter what troubles befall a project, no matter how many obstacles plague the way, it is crucial that the members continue to rely on each other and on themselves to see the task through to the end.
